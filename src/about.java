...
public class about extends JFrame{
	...
	private JPanel contentPane;
        ...
        public about() {
            ...
            super("About Us - Group 17");
            setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\acer p\\Pictures\\9b521072b95fb33098478108522bb993.jpg"));
            ...
            JLabel l6 = new JLabel("Developed By : Group 17");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : 1xyz@gmail.com");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Subscribe us on Youtube : XYZ");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Follow us on Instagram : 0XYZ1");
